  ...
  1:{name:"Session 1 — Fondamentaux",accent:"#00d4aa",rounds:[
    {id:1,title:"Contrat américain",subtitle:"Q1 — Créance export USD",
     ...
     marketData:{
       ...
       optionPut:"Put USD | Strike: 1,0900 | Prime: 2,00 % | Échéance: 90j | Banque Crédit Ouest\nPut USD | Strike: 1,0880 | Prime: 1,75 % | Échéance: 90j | Banque Atlantique",
       optionCall:"Call USD | Strike: 1,0900 | Prime: 2,10 % | Échéance: 90j | Banque Crédit Ouest\nCall USD | Strike: 1,0920 | Prime: 1,90 % | Échéance: 90j | Banque Atlantique",
       termaillage:"Taux financement Armor : 3,50 %/an\nEscompte client (paiement à 30j au lieu de 90j) : 0,60 %\nPénalité client (paiement à 180j au lieu de 90j) : 1,20 %\nEscompte fournisseur : N/A (pas de dette ce round)\nPénalité fournisseur : N/A",
     },
    ...
    {id:3,title:"Contrat japonais",subtitle:"Q3 — Créance export JPY",
     ...
     marketData:{
       ...
       optionPut:"Put JPY | Strike: 161,00 | Prime: 2,50 % | Échéance: 180j | Banque Crédit Ouest\nPut JPY | Strike: 160,50 | Prime: 2,20 % | Échéance: 180j | Banque Atlantique",
       optionCall:"Call JPY | Strike: 163,00 | Prime: 2,60 % | Échéance: 180j | Banque Crédit Ouest\nCall JPY | Strike: 163,50 | Prime: 2,30 % | Échéance: 180j | Banque Atlantique",
       termaillage:"Taux financement Armor : 3,50 %/an\nEscompte client (paiement à 3 mois au lieu de 6) : 0,50 % sur montant JPY\nPénalité client (paiement à 9 mois) : 0,80 % sur montant JPY\nEscompte fournisseur : N/A\nPénalité fournisseur : N/A",
    ...
    {id:4,title:"Besoin de liquidité immédiat",subtitle:"Q4 — Swap de change EUR/USD",
     ...
     marketData:{
       ...
       bpiNego:null,
       optionPut:"Put USD | Strike: 1,0880 | Prime: 1,80 % | Échéance: 30j | Banque Crédit Ouest\nPut USD | Strike: 1,0870 | Prime: 1,60 % | Échéance: 30j | Banque Atlantique",
       optionCall:"Call USD | Strike: 1,0880 | Prime: 1,90 % | Échéance: 30j | Banque Crédit Ouest\nCall USD | Strike: 1,0890 | Prime: 1,70 % | Échéance: 30j | Banque Atlantique",
       termaillage:"Taux financement Armor : 3,50 %/an\nEscompte client (encaissement anticipé à J+0) : 0,30 % sur 2M USD\nPénalité client (encaissement différé à 60j) : 0,50 % sur 2M USD\nEscompte fournisseur EUR (paiement différé 30j) : non accordé\nPénalité fournisseur EUR (paiement différé 30j) : 0,40 %",
       escompteClient:null, penaliteClient:null,
    ...
    {id:5,title:"Portefeuille multi-devises",subtitle:"Q5 — 3 expositions simultanées",
     ...
     marketData:{
       ...
       optionPut:"Put USD | Strike: 1,0880 | Prime: 1,80 % | 90j\nPut JPY | Strike: 161,50 | Prime: 2,20 % | 90j | Banques CO et ATL",
       optionCall:"Call GBP | Strike: 0,8660 | Prime: 1,50 % | 90j | Banques CO et ATL",
       termaillage:"Taux financement Armor : 3,50 %/an\nEscompte client USD (paiement immédiat) : 0,50 %\nPénalité client USD : N/A\nEscompte fournisseur GBP (paiement immédiat) : 0,80 %\nPénalité fournisseur GBP (paiement à 6 mois) : 1,10 %",
  ...
  2:{name:"Session 2 — Stratégies Avancées",accent:"#f59e0b",rounds:[
    {id:1,title:"Netting entre filiales",subtitle:"Q6 — Optimisation des flux internes",
     ...
     marketData:{
       ...
       swapDevises:"Échange de flux d'intérêts et de principal EUR/GBP — taux GBP fixe: 4,80 % | basis swap: −0,90 % | durée min: 1 an",
       optionPut:"Put GBP | Strike: 0,8650 | Prime: 1,40 % | Échéance: 90j | Banque Crédit Ouest\nPut GBP | Strike: 0,8640 | Prime: 1,20 % | Échéance: 90j | Banque Atlantique",
       optionCall:"Call GBP | Strike: 0,8660 | Prime: 1,50 % | Échéance: 90j | Banque Crédit Ouest\nCall GBP | Strike: 0,8670 | Prime: 1,30 % | Échéance: 90j | Banque Atlantique",
       termaillage:"Taux financement Armor : 3,50 %/an\nEscompte inter-filiales (règlement anticipé) : 0,40 %\nPénalité inter-filiales (règlement différé) : 0,60 %\nCoût d'opportunité trésorerie : 3,50 %/an",
    ...
    {id:2,title:"Appel d'offres international",subtitle:"Q7 — Soumission en USD",
     ...
     marketData:{
       ...
       swapDevises:"Échange de flux d'intérêts et de principal EUR/USD — taux USD fixe: 4,20 % | basis swap: −1,10 % | durée min: 1 an",
       optionPut:"Put USD | Strike: 1,0860 | Prime: 2,00 % | Échéance: 45j | Banque Crédit Ouest\nPut USD | Strike: 1,0850 | Prime: 1,80 % | Échéance: 45j | Banque Atlantique",
       optionCall:"Call USD | Strike: 1,0880 | Prime: 2,10 % | Échéance: 45j | Banque Crédit Ouest\nCall USD | Strike: 1,0890 | Prime: 1,90 % | Échéance: 45j | Banque Atlantique",
       termaillage:"Taux financement Armor : 3,50 %/an\nCondition d'encaissement anticipé (si AO remporté) : non négociable\nCondition de paiement différé : non applicable (AO en cours)",
       escompteClient:null, penaliteClient:null, escompteFournisseur:null, penaliteFournisseur:null,
     },
     computeHedgeResult:(instrument,banque,montant)=>{
    ...
    {id:3,title:"Financement international",subtitle:"Q8 — Swap de devises EUR/USD 3 ans",
     ...
     marketData:{
       ...
       optionPut:"Put USD | Strike: 1,0860 | Prime: 1,90 % | Échéance: 90j | Banque Crédit Ouest\nPut USD | Strike: 1,0850 | Prime: 1,70 % | Échéance: 90j | Banque Atlantique",
       optionCall:"Call USD | Strike: 1,0880 | Prime: 2,00 % | Échéance: 90j | Banque Crédit Ouest\nCall USD | Strike: 1,0890 | Prime: 1,80 % | Échéance: 90j | Banque Atlantique",
       termaillage:"Taux financement Armor : 3,50 %/an\nEscompte fournisseur USD (paiement anticipé du principal) : 0,50 %\nPénalité différé remboursement : 0,30 %/trim. supplémentaire\nCoût d'opportunité : 3,50 %/an",
       escompteClient:null, penaliteClient:null, escompteFournisseur:null, penaliteFournisseur:null,
     },
     computeHedgeResult:(instrument,banque,montant)=>{
       const m=Math.min(montant,2000000);
    ...
    {id:4,title:"Investissement au Maroc",subtitle:"Q9 — VAN d'un IDE + couverture MAD",
     ...
     marketData:{
       ...
       optionPut:"Put MAD | Strike: 11,20 | Prime: 2,00 % | Échéance: 1 an | Banque Crédit Ouest\nPut MAD | Strike: 11,15 | Prime: 1,80 % | Échéance: 1 an | Banque Atlantique",
       optionCall:"Call MAD | Strike: 11,30 | Prime: 2,10 % | Échéance: 1 an | Banque Crédit Ouest\nCall MAD | Strike: 11,40 | Prime: 1,90 % | Échéance: 1 an | Banque Atlantique",
       termaillage:"Taux financement Armor : 3,50 %/an\nEscompte client MAD (paiement à 6 mois au lieu de 12) : 1,00 %\nPénalité client MAD (paiement à 18 mois) : 1,50 %\nEscompte fournisseur : N/A\nPénalité fournisseur : N/A",
    ...
    {id:5,title:"Dividende de la filiale américaine",subtitle:"Q10 — Encaissement USD dans 3 mois",
     ...
     marketData:{
       ...
       swapDevises:"Échange de flux d'intérêts et de principal EUR/USD — taux USD fixe: 4,20 % | basis swap: −1,10 % | durée min: 1 an",
       optionPut:"Put USD | Strike: 1,0900 | Prime: 1,90 % | Échéance: 90j | Banque Crédit Ouest\nPut USD | Strike: 1,0880 | Prime: 1,70 % | Échéance: 90j | Banque Atlantique",
       optionCall:"Call USD | Strike: 1,1100 | Prime: 1,80 % | Échéance: 90j | Banque Crédit Ouest\nCall USD | Strike: 1,1120 | Prime: 1,60 % | Échéance: 90j | Banque Atlantique",
       termaillage:"Taux financement Armor : 3,50 %/an\nEncaissement anticipé dividende (à J+30) : escompte 0,40 % consenti par la filiale\nEncaissement différé (à J+180) : pénalité 0,80 % demandée par Armor\nCoût d'opportunité placement 90j : 1,20 %/trim. (MM)",
       escompteClient:"0,40 % pour encaissement à J+30 (au lieu de J+90)",
       penaliteClient:"0,80 % si encaissement différé à J+180",
       escompteFournisseur:null, penaliteFournisseur:null,
     },
     computeHedgeResult:(instrument,banque,montant)=>{
...
const ALL_INSTRUMENTS = [
  ...
  // Options sur devises
  {id:"option_put",       label:"Option put (droit de vendre la devise)",      icon:"🛡️", group:"Options"},
  {id:"option_call",      label:"Option call (droit d'acheter la devise)",     icon:"🛡️", group:"Options"},
